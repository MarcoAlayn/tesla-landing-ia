                ...
                hover:bg-white hover:text-black transition-colors ease-out duration-300'
                  ...
                  <div className='relative text-center text-xs text-white '>
                    <span>
                      ...
                      Después, si lo deseas, puedes editarlo para ajustarlo a
                      tus necesidades.
                    </span>
                  </div>
                      ...
                      <div className='flex w-full items-center flex-col'>
                        <div className='flex w-full flex-col gap-1.5 rounded-[26px] bg-[#424242] py-2 pl-5 pr-1.5'>
                          <div className='flex items-center gap-1.5 md:gap-2'>
                            ...
                            <button
                              className='mb-1 me-1 flex h-8 w-8 items-center justify-center rounded-full text-white focus-visible:outline-none focus-visible:outline-black disabled:bg-[#979797] disabled:text-[#afafaf] dark:bg-white dark:text-black dark:focus-visible:outline-white hover:bg-neutral-500 disabled:hover:bg-[#979797] disabled:pointer-events-none transition-colors ease-out duration-300'
                              type='submit'
